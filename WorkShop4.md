...
- Запускаем сцену и верный кубик падает на нижный и красит оба кубика в соответствии с результатами работы перцептрона в списке testResults. Если total error в итоге равен 0, то сцена отработает корректно.

## Выводы

Я изучил устройство перцептрона и понял принцип его работы. Создал перцептроны, реализующие логические элементы. Визуализировад в гугл таблице зависимости количества эпох от ошибки обучения и понял от чего зависит необходимое количество эпох. Построил визуальную модель работы перцептрона в Unity.
